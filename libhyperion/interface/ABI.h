...
private:
	...
	/// @a _hyperionTypes is the list of original Hyperion types where @a _encodingTypes is the list of
	...
	/// @a _hyperionType is the original Hyperion type and @a _encodingTypes is the
