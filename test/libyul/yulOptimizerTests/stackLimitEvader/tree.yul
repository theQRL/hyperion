...
// {
//     {
//         mstore(0x40, memoryguard(0x0180))
//         sstore(23, f())
//     }
//     function f() -> v
//     {
...
//     function g() -> v_1
//     {
//         mstore(0x0100, calldataload(mul(1, 4)))
...
//         mstore(0x0100, calldataload(mul(0, 4)))
...
//         sstore(mul(3, 4), a3_4)
//         sstore(mul(2, 4), a2_3)
//         sstore(mul(1, 4), mload(0x0100))
//         v_1 := i()
//     }
//     function h() -> v_19
//     {
//         mstore(0xc0, calldataload(mul(1, 4)))
//         mstore(0x0100, calldataload(mul(2, 4)))
...
//         let a18 := calldataload(mul(18, 4))
//         let a19 := calldataload(mul(19, 4))
//         sstore(0, add(mload(0xc0), mload(0x0100)))
//         sstore(mul(17, 4), a19)
//         sstore(mul(17, 4), a18)
...
//         sstore(mul(2, 4), mload(0x0100))
//         sstore(mul(1, 4), mload(0xc0))
//         v_19 := i()
//     }
//     function i() -> v_37
//     {
//         mstore(0x0140, calldataload(mul(1, 4)))
...
//         mstore(0x0140, calldataload(mul(0, 4)))
