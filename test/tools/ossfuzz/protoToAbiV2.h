...
/**
 * Template of the hyperion test program generated by this converter is as follows:
 *
 *	pragma hyperion >=0.0;
...
/// Converts a protobuf input into a Hyperion program that tests
/// abi coding.
...
private:
	...
	/// Convert test function specification into Hyperion test
	/// function
	/// @param _testSpec: Protobuf test function specification
	/// @param _storageDefs: String containing Hyperion assignment
	...
	/// the input protobuf specification type into Hyperion code.
	/// @return A pair of strings, first of which contains Hyperion
	/// code to be placed inside contract scope, second of which contains
	/// Hyperion code to be placed inside test function scope.
	...
	/// Convert a protobuf type @a _T into Hyperion code to be placed
	...
	/// @param: _isValueType is true if _type is a Hyperion value type e.g., uint
	...
	/// Convert a protobuf type @a _T into Hyperion variable assignment and check
	/// statements to be placed inside contract and test function scopes.
	/// @param: _varName is the name of the Hyperion variable
	/// @param: _paramName is the name of the Hyperion parameter that is passed
	/// to the test function
	/// @param: _type (of parameterized type protobuf type T) is the type
	/// of protobuf input to be converted.
	/// @return: A pair of strings, first of which contains Hyperion
	/// statements to be placed inside contract scope, second of which contains
	/// Hyperion statements to be placed inside test function scope.
	template <typename T>
	...
	/// Convert a protobuf type @a _T into Hyperion variable declaration statement.
	/// @param: _varName is the name of the Hyperion variable
	/// @param: _paramName is the name of the Hyperion parameter that is passed
	/// to the test function
	/// @param: _type (of parameterized type protobuf type T) is the type
	...
	/// Hyperion value type e.g., uint and false otherwise e.g., string
	/// @param: _location is the Hyperion location qualifier string to
	/// be used inside variable declaration statements
	/// @return: A pair of strings, first of which contains Hyperion
	/// variable declaration statement to be placed inside contract scope,
	/// second of which contains Hyperion variable declaration statement
	...
	/// Returns a Hyperion variable declaration statement
	/// @param _type: string containing Hyperion type of the
	/// variable to be declared.
	/// @param _varName: string containing Hyperion variable
	/// name
	...
	/// Return checks that are encoded as Hyperion if statements
	/// as string
	...
	/// Return commonly used Hyperion helper functions as string
	...
	/// Return a pair of names for Hyperion variable and the same variable when
	...
	/// Checks if the last dynamically encoded Hyperion type is right
...
/// Visitor interface for Hyperion protobuf types.
template <typename T>
...
/// Converts a protobuf type into a Hyperion type string.
...
public:
	...
	bool visit(StructType const& _type) override
	{
		...
		// being defined (which is a Hyperion error).
