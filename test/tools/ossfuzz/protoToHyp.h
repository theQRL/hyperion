...
namespace hyperion::test::hypprotofuzzer
{
...
public:
	...
	std::string protoToHyperion(Program const&);
...
private:
	...
	/// type and return its hyperion translation.
	...
	/// tests only) and a hyperion test case
