...
class TestEthGasReport(unittest.TestCase):
    ...
    def test_parse_report_should_fail_if_row_matching_same_method_call_appears_twice(self):
        text_report = dedent("""
            | Methods                                               |
            | SQRCTB1Token · mint() · 47934 · 59804 · 57826 · 6 · - |
            | SQRCTB1Token · mint() · 11111 · 22222 · 33333 · 4 · - |
        """).strip('\n')
        expected_message = dedent("""
            Parsing error on line 3: Duplicate method row for 'SQRCTB1Token.mint()'.
            | SQRCTB1Token | mint() | 11111 | 22222 | 33333 | 4 | - |
        """).strip('\n')
    ...
    def test_parse_report_should_fail_if_row_matching_same_contract_deployment_appears_twice(self):
        text_report = dedent("""
            ...
            | SQRCTB1Token · - · - · 111111 ·      0.6 % · - |
        """).strip('\n')
        expected_message = dedent("""
            Parsing error on line 3: Duplicate contract deployment row for 'SQRCTB1Token'.
            | SQRCTB1Token | - | - | 111111 |      0.6 % | - |
        """).strip('\n')
