...
def download_benchmarks(
    ...
    github = Github('theQRL/hyperion', debug_requests) # TODO(now.youtrack.cloud/issue/TS-16)
    circleci = CircleCI('theQRL/hyperion', debug_requests) # TODO(now.youtrack.cloud/issue/TS-16)
