...
def examine_id_coverage(top_dir, source_id_to_file_names, new_ids_only=False):
    ...
    old_source_only_ids = {
        "1218", "1584", "1823",
        "1988", "2066", "2833", "3356", "3366",
        "3893", "3996", "4010", "4458", "4802",
        "4902", "5272", "5622", "5798", "5840", "6708", "7128", "7400",
        "7589", "7593", "7649", "7710",
        "8065", "8084", "8140", "8158",
        "8312", "8592", "9134", "9272", "9429", "9609", "9857",
    }
...
def main(argv):
    ...
    source_file_names = find_files(
        cwd,
        ["libqrvmasm", "liblangutil", "libhypc", "libhyperion", "libhyputil", "libyul", "hypc"],
        [".h", ".cpp"]
    )
